...
class Wrapper implements WrapperInterface {
	...
	*/
	...
	/**
	 * Возвращает экземпляр класса Framework\Components\Database\PostgreSQL\Transaction
	 *
	 * @throws DatabaseException
	 *
	 * @return Transaction
	...
	public function transaction(){
		...
		if(!class_exists('Framework\Components\Database\PostgreSQL\Transaction')){
			throw new DatabaseException("Class Framework\\Components\\Database\\PostgreSQL\\Transaction not found");
		}
