...
class Cache {
	...
	*/
	public static function getMemcache(){
		...
		if(!class_exists('Framework\Components\Cache\Memcache')){
	...
	/**
	 * Возвращает экземпляр класса Framework\Components\Cache\Redis
	 *
	 * @return Redis()
	 */
	public static function getRedis(){
		...
		if(!class_exists('Framework\Components\Cache\Redis')){
	...
	/**
	 * Возвращает экземпляр класса Framework\Components\Cache\File
	 *
	 * @return File()
	 */
	public static function getFile(){
		...
		if(!class_exists('Framework\Components\Cache\File')){
