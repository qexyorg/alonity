...
class Image {
	...
	public function scale($multiply){
		...
		if($multiply<=0){
			throw new FileException('scale multiply must be more then 0');
		}
	...
	public function extensions($extensions){
		if(!is_array($extensions)){
			throw new FileException('extensions must be array');
		}

		if(empty($extensions)){
			throw new FileException('extensions must be not empty');
		}
	...
	*/
	...
	public function resize($width, $height){
		...
		if($width<=0){
			throw new FileException('resize width must be more then 0');
		}

		if($height<=0){
			throw new FileException('resize height must be more then 0');
		}
	...
	*/
	public function quality($quality){
		...
		if($quality<=0){
			throw new FileException('image quality must be more then 0');
		}
